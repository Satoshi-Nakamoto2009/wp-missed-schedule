...
Plugin URI: https://slangji.wordpress.com/wp-missed-schedule-beta/
Description: WordPress plugin WP Missed Schedule Fix scheduled posts that failed future real cron job: finds only all that matches this problem, and re-publish correctly 10 items each session, every 10 minutes, the others are corrected on the next sessions, for not wasting resources, until no longer exist. The configuration of this plugin is Automatic! Free (UNIX STYLE) Beta Branche 2015 - Build 2015-08-28 - The miss link is for verify if exist this issue. The cron link requires <a href="https://wordpress.org/plugins/wp-crontrol/">WP Crontrol</a> activated and WP 2.7+ or later. <a href="https://slangji.wordpress.com/wp-missed-schedule/">Stable Branche 2014</a> This software is still beta, we don't recommend to run it on a production site. No support is provided.
Author: sLaNGjIs
Author URI: https://slangji.wordpress.com/plugins/
Version: 2015.1231.3.0
 ...
 *
 * STABLE Release: Version 2015 Build 1231 Revision 2016 Update 0
 *
 * REQUIREMENTS
 *
 ...
 *
 * [WP Missed Schedule Beta](https://wordpress.org/plugins/wp-missed-schedule-beta/)
 *
 * Fix Missed Schedule Failed Scheduled Posts Future Real Cron Job.
 *
 ...
 * of future assistance from your own author or others authors.
 *
 ...
 */
	 ...
	 * @description Fix Missed Schedule Failed Scheduled Posts Future Real Cron Job
	...
	add_action( 'init', 'wpms_2015_event', 0 );
